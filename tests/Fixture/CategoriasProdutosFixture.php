...
class CategoriasProdutosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'nome_categoria' => ['type' => 'string', 'length' => 220, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2020-11-28 00:07:56',
                'modified' => '2020-11-28 00:07:56',
            ],
        ];
        parent::init();
    }
